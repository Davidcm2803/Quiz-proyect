  ...
  return (
    <main className="min-h-[calc(100vh-4rem)] bg-gray-50 px-4 py-10">
      <div className="max-w-xl mx-auto space-y-5">
        ...
        {/* Secciones */}
        <div className="text-right bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="bg-white rounded-2xl border border-red-100 shadow-sm px-5 py-4">
          ...
          <button
            ...
            className="flex items-center gap-2 text-xs font-semibold text-red-600
              bg-red-50 hover:bg-red-100 px-3 py-2 rounded-xl transition-colors"
          >
            <Trash2 size={13} />
            Eliminar mi cuenta
          </button>
...
function InfoRow({ label, value, mono = false, capitalize = false }) {
  return (
